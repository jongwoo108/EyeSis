...
```
┌─────────────────────────────────────────────────────────────────┐
│                    FaceWatch Evolution Timeline                  │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  Phase 1                Phase 2                Phase 3          │
│  ───────                ───────                ───────          │
│  서버사이드 렌더링       클라이언트사이드        WebSocket 도입   │
│  HTTP POST              렌더링                                   │
│  이미지 전송            좌표 전송               실시간 스트리밍   │
│                                                                  │
│  ────────────────────────────────────────────────────────▶      │
│                                                                  │
│  Phase 4                Phase 5                Phase 6          │
│  ───────                ───────                ───────          │
│  Bank 시스템            옆모습 감지             박스 렌더링       │
│  Multi-Bank             각도 추정              최적화            │
│  자동 학습              각도별 저장                               │
│                                                                  │
│  ────────────────────────────────────────────────────────▶      │
│                                                                  │
...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  Before (Phase 1-6)                After (Phase 7)          │
│  ──────────────────                ─────────────────        │
│                                                              │
│  script.js                         script.js (entry)        │
│  ┌─────────────────┐               ┌─────────────────┐      │
│  │                 │               │    imports      │      │
│  │    4,152 lines  │               │    + core logic │      │
│  │                 │               │   (~2,111 lines)│      │
│  │   모놀리식 구조  │               └────────┬────────┘      │
│  │                 │                        │               │
│  │   - 함수 혼재   │               ┌────────▼────────┐      │
...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  [Client - ES Modules]                [Server - FastAPI]    │
│                                                              │
│  script.js ────────────────────────▶ WebSocket /ws/detect  │
│      │                                      │               │
│      ├── handlers.js                        ▼               │
│      ├── detection.js              ┌──────────────────┐    │
│      ├── timeline.js               │ Face Detection   │    │
│      ├── persons.js                │ ├─ RetinaFace    │    │
│      ├── clips.js                  │ ├─ buffalo_l     │    │
│      ├── snapshots.js              │ └─ Bank Matching │    │
│      ├── log.js                    └──────────────────┘    │
│      ├── enroll.js                          │               │
│      │                                      ▼               │
│      ├── config.js ◀──────────────▶ PostgreSQL            │
│      ├── state.js                   + File Storage         │
│      ├── ui.js                      (.npy embeddings)      │
│      ├── utils.js                                          │
│      └── api.js                                            │
│                                                              │
└─────────────────────────────────────────────────────────────┘
